                    ...
                    <div className="home-left col-md-3">
                        <div className="heading-container">
                            ...
                            <div className="social-media">
                                ...
                                <a href="https://www.linkedin.com/in/devang-singh/" target="_blank"><img style={{ pointerEvents:"none" }} className="pl-2" src={lnkdn} alt=""/></a>
                                <a href="https://github.com/devang1144" target="_blank"><img style={{ pointerEvents:"none" }} className="pl-2" src={glogo} alt=""/></a>
                            </div>
